...
import type { Product, ProductVariant } from "@/lib/hygraph/types"
...
import { getProductId } from "@/lib/hygraph/utils"
...
export function AddToCart({
  ...
  const isTargetingProduct = pathname.handle === product.handle || searchParams.get("pid") === getProductId(product.id)
