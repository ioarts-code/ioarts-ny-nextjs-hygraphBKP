...
import { getCollection, getProduct, getProducts } from "@/lib/hygraph"
...
import { storeCatalog } from "@/lib/hygraph/constants"
import Prose from "@/components/prose"
import { formatPrice } from "@/lib/hygraph/utils"
    ...
    <PageLayout className="bg-muted">
      ...
      <div className="flex flex-col md:grid md:grid-cols-12 md:gap-sides min-h-max">
        ...
        <div className="flex sticky top-0 flex-col col-span-5 2xl:col-span-4 max-md:col-span-full md:h-screen min-h-max max-md:p-sides md:pl-sides md:pt-top-spacing max-md:static">
          ...
          <p className="text-xs 2xl:text-sm text-muted-foreground leading-tight mb-4 max-md:hidden mt-4">
            Premium quality products powered by modern e-commerce technology.
          </p>
